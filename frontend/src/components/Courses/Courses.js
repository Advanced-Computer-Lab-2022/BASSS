      ...
      <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
        ...
        {courses.map((filter) => (
            ...
            //   key={author._id}
              ...
              >
              <TableCell align="center">{filter.Title}</TableCell>
              <TableCell align="center">{filter.TotalHours}</TableCell>
              <TableCell align="center">{filter.Rating}</TableCell>
              <TableCell align="center">{filter.Price}</TableCell>
            </TableRow>
